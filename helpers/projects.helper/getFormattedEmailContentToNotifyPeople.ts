...
export const getFormattedEmailContent = function (projectInfo: any) {
  ...
  const emailBody = `
   ...
   <head>
    ...
    We are excited to inform you about a new project listed on our website: "${projectInfo.name}".
    <br>
    <br>
    Please find the attachments for this project below:
    <br>
    <br>
    ${attachmentsHTML}
